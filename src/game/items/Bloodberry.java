...
/**
 * A subclass of Item which implements the Consumable and Sellable Interface, representing a
 * consumable Item (Blood-berry). It can be sold by the player.
 *
...
public class Bloodberry extends Item implements Consumable, Sellable {
  ...
  /**
   * The base selling price of the blood-berry
   */
  ...
  /**
   * List of allowable actions that blood-berry can perform to the current actor This item can be
  ...
  /**
   * Consumes the blood berry and returns a message with the amount of maximum health gained by the
   * actor. The blood berry increases the actor's maximum health by 5 points and is removed once it
   * is consumed.
   *
   * @param actor The actor who consumes the bloodberry
   * @return a string representing a message with the amount of maximum health increased by the
   * actor
   */
  @Override
  ...
  /**
   * Sells the blood berry and returns a message showing that the player has sold the item after
   * selling the item, the blood-berry is removed from the player's inventory
   *
