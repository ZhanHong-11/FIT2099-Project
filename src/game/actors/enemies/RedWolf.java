...
public class RedWolf extends Actor {
    ...
    private String dropItem(GameMap map) {
        ...
        return "The Red Wolf drops " + String.join(" and ", droppedItems) + " at " + actorLocation;
    }
